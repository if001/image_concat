...
def predict(img_path1, img_path2):
    ...
    result = single.decoder.predict(encoded1)
    result = (result * 255.)
    return result


def predict_output(img_path1, img_path2):
    img1 = np.array([DataOpt.img_open(img_path1)])
    img2 = np.array([DataOpt.img_open(img_path2)])
...
def main():
    img_path1 = "./data_opt_mod/get_pokemon_img/img/1010fd06641d6ebeedd80a6efbaacdb7.png"
    img_path2 = "./data_opt_mod/get_pokemon_img/img/004e03952b0150caf6f74db255dbfbdf.png"
